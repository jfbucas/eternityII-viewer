...
puzzles[ nb_puzzles ] = "brendan/pieces_05x04.txt.js,Brendan 05x04".split( splitreg ); nb_puzzles++;

if ( puzzle == "brendan/pieces_05x04.txt.js" ) {
...
pieces[ p ] = "3,3,3,4".split( splitreg ); p++;
pieces[ p ] = "3,3,4,4".split( splitreg ); p++;
pieces[ p ] = "3,3,5,5".split( splitreg ); p++;
pieces[ p ] = "3,4,3,5".split( splitreg ); p++;
pieces[ p ] = "4,4,4,5".split( splitreg ); p++;
