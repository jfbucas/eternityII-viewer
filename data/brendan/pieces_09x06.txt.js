...
puzzles[ nb_puzzles ] = "brendan/pieces_09x06.txt.js,Brendan 09x06".split( splitreg ); nb_puzzles++;

if ( puzzle == "brendan/pieces_09x06.txt.js" ) {
...
pieces[ p ] = "4,4,4,8".split( splitreg ); p++;
pieces[ p ] = "4,5,7,5".split( splitreg ); p++;
pieces[ p ] = "4,5,9,9".split( splitreg ); p++;
pieces[ p ] = "4,5,10,8".split( splitreg ); p++;
pieces[ p ] = "4,6,5,7".split( splitreg ); p++;
pieces[ p ] = "4,6,6,5".split( splitreg ); p++;
pieces[ p ] = "4,6,6,10".split( splitreg ); p++;
pieces[ p ] = "4,6,10,8".split( splitreg ); p++;
pieces[ p ] = "4,7,5,5".split( splitreg ); p++;
pieces[ p ] = "4,7,9,7".split( splitreg ); p++;
pieces[ p ] = "4,9,6,8".split( splitreg ); p++;
pieces[ p ] = "4,10,7,6".split( splitreg ); p++;
pieces[ p ] = "4,10,7,8".split( splitreg ); p++;
pieces[ p ] = "4,10,7,9".split( splitreg ); p++;
pieces[ p ] = "4,10,10,7".split( splitreg ); p++;
pieces[ p ] = "5,5,5,9".split( splitreg ); p++;
pieces[ p ] = "5,5,9,6".split( splitreg ); p++;
pieces[ p ] = "5,6,6,10".split( splitreg ); p++;
...
pieces[ p ] = "6,7,10,9".split( splitreg ); p++;
